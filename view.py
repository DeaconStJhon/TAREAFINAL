...
class GraphApp:
    def __init__(self, master):
        ...
        self.logo_image = Image.open("D://Alonso//Downloads//workspacepy0224-main//workspacepy0224-main//modulo5//proyecto//imagenes//LOGO-DATUX.png")  # Reemplaza "logo.png" con la ruta de tu imagen
    ...
    def create_widgets(self):
        ...
        # Botón 
        self.generate_button_1 = ttk.Button(button_container, text="Reporte Relacion Edad-Cantidad Consumida", command=self.generate_graph, style="Large.TButton")
    ...
    def generate_graph(self):
        ...
        ## (cambiar) titulo
        ax.set_title('Relación entre Edad y Cantidad consumida')
